...
def departments_all(request):
    ...
    return render(template_name='index8_home.html', request=request, context={"department_list": context})


def wards_all(request):
    context = Ward.objects.all()

    return render(template_name='index8_home.html', request=request, context={"ward_list": context})
